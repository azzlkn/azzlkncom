    ...
    <div className='container mx-auto px-3'>
      ...
      <div className='pt-3'>
        <p className='font-body font-light'>
          Ay sona ererken o ay yaşanan yazılım, teknoloji, kahve, kitap ve daha
          birçok konuda özenle hazırlanmış bir ay sonu bültenidir. Mail adresini
          kaydederek sen de her ayın son pazarı saat 11:00'de posta kutunda
          güzel içeriklere ulaşabilirsin.
        </p>
      </div>
